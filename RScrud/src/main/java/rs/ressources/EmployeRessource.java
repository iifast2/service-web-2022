...
public class EmployeRessource {
	...
	//@Path("ajouter")     // amine pour tester :   url: /employee/ajouter
	@POST	
...
/*	@POST
	@Consumes(MediaType.APPLICATION_XML)
	@Produces(MediaType.APPLICATION_JSON)// Par d�faut
...
// searchEmployee : recherche : parcours liste des employee to find getCin() = cin
	@GET
	...
	*/	
	...
	public Response updateEmploye(Employe e) {
		...
		if (index!=-1) {
			employes.set(index, e); // index + employee e
